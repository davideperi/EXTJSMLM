...
folder are mapped to the application's root namespace, 'MultiLanguageNative'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "MultiLanguageNative"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'MultiLanguageNative' in the same way
as `"MultiLanguageNative/sass/src"`.
